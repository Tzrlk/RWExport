...
function GenerateForm {
      ...
      $handler_RunButton_Click={
         ...
         if ($ForceCheck.Checked) {
            ...
            if (Test-Path ".\ValidateInput.ps1") {
               $ValidInput = &(".\ValidateInput") $ScriptText.Text $SourceText.Text $DestinationText.Text $SortMethod ($SimpleImgText.Text).ToInt32($null) ($SmartImgText.Text).ToInt32($null) $ExtractFilesCheck.Checked $CSSText.Text $SplitTopicsCheck.Checked $LogCheck.Checked $LogText.Text "GUI"
   ...
   $CSSText.Text = “RWExport_091b_1.0.css”
